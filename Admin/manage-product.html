    ...
    <table class="product-table">
        ...
        <tbody>
            <tr>
                ...
                <!-- <td></td> -->
                <td>
                <a href="./update_movie.php">  <img src="../Images/admin-images/edit.png" alt="Product 1" class="icon" style="height:30px;"></a>
                <img src="../Images/admin-images/delete.png" alt="Product1" class="icon" style="height:30px;">
                </td>
            </tr>
